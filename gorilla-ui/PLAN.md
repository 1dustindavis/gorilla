...
1. Complete WinUI app scaffolding/wiring:
   ...
   - Progress: `gorilla-ui/Gorilla.UI.slnx` created, scaffold helper added at `gorilla-ui/tools/scaffold-winui.ps1`, implementation blueprint added at `gorilla-ui/src/Gorilla.UI.App/WIRING_BLUEPRINT.md`, copy-ready app wiring templates added under `gorilla-ui/src/Gorilla.UI.App/template/`, and Windows runbook added at `gorilla-ui/src/Gorilla.UI.App/WINDOWS_VM_EXECUTION.md`.
